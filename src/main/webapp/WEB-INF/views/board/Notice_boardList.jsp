	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 style="font-size: 25px; font-weight: 700;">공지사항</h1>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header" style="background-color: #007bff;">
								<h3 class="card-title" style="font-size: 15px; color: #fff">공지사항
									게시판 입니다.</h3>
							</div>
										...
										<c:when test="${mb.m_grade == '운영자' || mb.m_grade == '부운영자'}">
											<div class="float-left">
												<button type="button" class="btn btn-primary"
													onclick="location.href='./notice_writeFrm'">
										...
										<c:forEach var="bitem" items="${bList}">
											<tr class="content">
												...
												<th class="t-select" style="font-weight: 500;"><a
													href="./notice_contents?bnum=${bitem.bnum}">
														${bitem.btitle} </a></th>
