	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 style="font-size: 25px; font-weight: 700;">1:1 게시판</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">1:1 게시판</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header" style="background-color: #007bff;">
								<h3 class="card-title" style="font-size: 15px; color: #fff">1:1
									문의 게시판 입니다.</h3>
							</div>
							...
							<div class="card-body">
								<div class="float-left">
									<button type="button" class="btn btn-primary"
										onclick="location.href='./oneone_writeFrm'">
								...
								<c:choose>
									<c:when test="${mb.m_grade == '운영자' || mb.m_grade == '부운영자'}">
												...
												<c:forEach var="bitem" items="${bList}">
													<tr class="content">
														...
														<th class="t-select" style="font-weight: 500;"><a
															href="./oneone_contents?bnum=${bitem.bnum}">
																${bitem.btitle} </a></th>
														<th class="t-writer" style="font-weight: 500;">${bitem.mname}</th>
														<th class="t-writer" style="font-weight: 500;">${bitem.bid}</th>
										...
										<table id="example2" class="table table-bordered table-hover"
											...
											<tbody>
												<c:forEach var="bitem" items="${bmyList}">
													<tr class="content">
														<th class="t-select" style="font-weight: 500;"><a
															href="./oneone_contents?bnum=${bitem.bnum}">
																${bitem.btitle} </a></th>
