		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 style="font-size: 25px; font-weight: 700;">공지사항 게시글</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">공지사항 게시글</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-9">
							<div class="card card-primary card-outline">
								...
								<div class="card-body p-0">
									...
									<div class="mailbox-controls with-border text-center">
										<!-- /.mailbox-controls -->
										<div class="mailbox-read-message" style="font-size: 16px; height: 450px; text-align: left;">${board.bcontents}
										</div>
							...
							첨부된 파일이 없습니다.
													...
													<c:forEach var="fitem" items="${fList}">
														<a
															href="./notice_download?bf_sysname=${fitem.bf_sysname}&bf_oriname=${fitem.bf_oriname}">
									...
									<div class="card-footer">
										<div class="float-right">											
											<button type="button" class="btn btn-default"
												onclick="location.href='./notice_list?pageNum=${pageNum}'">
												<i class="fas fa-bars"></i> 목록
											</button>
										</div>								
										<button type="button" class="btn btn-primary" id="upbtn"
											onclick="location.href='./notice_updateFrm?bnum=${board.bnum}'">
...
function delCheck(bnum){
	...
	if(conf == true){
		location.href='./notice_delete?bnum=' + bnum;
	}
}
</script>
<script type="text/javascript">
