		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 style="font-size: 25px; font-weight: 700;">1:1 문의</h1>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title" style="font-size: 15px;">1:1 문의 게시판 입니다.</h3>
								</div>
								<!-- /.card-header -->

								<!-- form start -->
								<form action="./oneone_boardWrite" class="write-form"
