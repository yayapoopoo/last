	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 style="font-size: 25px; font-weight: 700;">QR 등록</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">QR 등록</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="card card-primary">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form id="quickForm" action="./qrcodeWrite" class="write-form"
								method="post" enctype="multipart/form-data">
								<!-- 로그인한 id(숨김), 제목, 내용, 파일-->
								<div class="content_title">
									<input type="hidden" name="qid" value="${mb.m_id}">
									<div class="card-body">
										<div class="form-group">
											<label>디자인을 선택해주세요</label> <select class="form-control"
												name="qselect" required>
										...
										<div class="filebox">
											<!-- 파일 입력 처리 영역 -->
											<label>첨부파일</label> <input type="file" name="files" id="file"
												multiple> <input type="text" class="upload-name"
												value="파일선택" readonly>
